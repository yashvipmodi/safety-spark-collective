...
const AdvocacyAndLegislation = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-green-100 p-4 md:p-8">
      <h1 className="text-2xl md:text-3xl font-bold mb-4">Advocacy and Legislation</h1>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">Local Resources</h2>
        <p className="mb-4">Find nearby police stations and gun-related information centers:</p>
        <ul className="list-disc pl-5 mb-6 space-y-2">
          <li><a href="https://www.google.com/maps/search/police+stations" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Nearby Police Stations</a></li>
          <li><a href="https://www.google.com/maps/search/gun+safety+courses" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Gun Safety Courses</a></li>
          <li><a href="https://www.google.com/maps/search/firearm+education+centers" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Firearm Education Centers</a></li>
          <li><a href="https://www.google.com/maps/search/gun+violence+prevention+organizations" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Gun Violence Prevention Organizations</a></li>
        </ul>
      </section>
