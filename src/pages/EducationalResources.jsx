...
const EducationalResources = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-green-100 p-8">
      <h1 className="text-3xl font-bold mb-4 text-blue-800">Educational Resources</h1>
      <p className="mb-4 text-blue-600">Access materials to educate yourself and others about responsible gun ownership, safety, and prevention:</p>
      
      <h2 className="text-2xl font-semibold mb-3 text-blue-800">Online Courses and Webinars:</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 text-blue-800">Research and Reports:</h2>
      <ul className="list-disc pl-5 mb-6 space-y-2 text-blue-700">
      ...
      <h2 className="text-2xl font-semibold mb-3 text-blue-800">Law Enforcement and Community Resources:</h2>
      <ul className="list-disc pl-5 mb-6 space-y-2 text-blue-700">
      ...
      <h2 className="text-2xl font-semibold mb-3 text-blue-800">Advocacy and Education Programs:</h2>
      <ul className="list-disc pl-5 mb-6 space-y-2 text-blue-700">
